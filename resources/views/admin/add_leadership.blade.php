            ...
            <div class="panel-body">
                <div class="row">
                   ...
                   {{ Session::put('lead',null)}}
                    @endif
                    <div class="col-lg-12">
                        <form action="{{url('/save/leadership')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="3" id="editor_summery" required=""></textarea>
